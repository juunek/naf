...
if (isset($_GET['TID'])) { // note that the spelling 'pid' is based on the query string variable name
	...
	// validate the product id -- check to see if it is greater than 0
		if ($TID>0 ){
			//compose the query
			$sql = "DELETE from Testimonials WHERE TID = ?"; // note that the spelling "PID" is based on the field name in the database product table.
...
<div class='container'>
    ...
    <div class='col-10 mx-auto'>
        ...
        <p class='text-center'>Back to the <a href='testimonialsShow.php'>Testimonials Page</a></p>
    </div>
