...
if (isset($_GET['CID'])) { // note that the spelling 'pid' is based on the query string variable name
	...
	// validate the product id -- check to see if it is greater than 0
		if ($CID>0 ){
			//compose the query
			$sql = "DELETE from NAFContact WHERE CID = ?"; // note that the spelling "PID" is based on the field name in the database product table.
	...
	$output = "<h2 class='text-center text-danger my-5'>Error</h2><p class='text-center'>To manage contact records, please follow the link below to visit the admin page.  Thank you. </p>";
}
...
<div class='container'>
    ...
    <div class='col-10 mx-auto'>
        ...
        <p class='text-center'>Back to the <a href='contactShow.php'>Contact Us Page</a></p>
    </div>
