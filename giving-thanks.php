...
<html lang="en">
  <head>
  <title>Giving Thanks For Charitable Donations | Neuro Assitance Foundation</title>
    <!-- Required meta tags -->
    <meta charset="utf-8">
    <meta name="viewport" content="width=device-width, initial-scale=1">
     <meta name="description" content="Neuro Assistance Foundation gives thanks for the charitable donations of wheelchair vans and other adaptable vans for people with spinal cord injuries.">
...
if ($stmt->prepare($sql)) {
    ...
    <div class='col-md-4'>
      <img class='mb-4 mt-2 w-100' src='img/$GTImage'  alt='$GTHeader' Image title= '$GTHeader Image'>
      <img class='mb-4 mt-2 w-100' src='img/$GTAdditionalImage'  alt='$GTAdditionalImageAltText' title= '$GTAdditionalImageAltText Image'>
    </div>
